...
fun IndexScreen(modifier: Modifier = Modifier, viewModel: UIViewModel = viewModel()) {
    ...
    Box(modifier = modifier.fillMaxSize()) {
        AsyncImage(
            ...
            modifier = Modifier
                .fillMaxSize().blur(10.dp).alpha(10f),
            ...
            LazyColumn(
                ...
                item{
                    NavTopBar {
                        Text(text = "梦想之门", color = Color(0xFF6A0DAD),
                ...
                item{
                    Column(modifier = Modifier.fillMaxSize()) {
                        ...
                        HorizontalPager(state = pagerState,
                            contentPadding = PaddingValues(10.dp)) { index ->
                        ...
                        Row (
                            ...
                            images.indices.forEach{ radioIndex ->
                                RadioButton(modifier = Modifier.scale(0.5f), selected = radioIndex == pagerState.currentPage, onClick = {
